...
public class GameView {
    ...
    public TilePane makeTile(int i, int j){
        ...
        if (controller.getModel().getActivePuzzle().getCellType(i, j) == CellType.CLUE  && controller.getModel().getActivePuzzle().getClue(i, j) == 0) {
        ...
        if (controller.getModel().getActivePuzzle().getCellType(i, j) == CellType.CLUE && controller.getModel().getActivePuzzle().getClue(i, j) == 1) {
        ...
        if (controller.getModel().getActivePuzzle().getCellType(i, j) == CellType.CLUE && controller.getModel().getActivePuzzle().getClue(i, j) == 2) {
        ...
        if (controller.getModel().getActivePuzzle().getCellType(i, j) == CellType.CLUE && controller.getModel().getActivePuzzle().getClue(i, j) == 3) {
        ...
        if (controller.getModel().getActivePuzzle().getCellType(i, j) == CellType.CLUE && controller.getModel().getActivePuzzle().getClue(i, j) == 4) {
        ...
        if (controller.getModel().getActivePuzzle().getCellType(i, j) == CellType.WALL) {
