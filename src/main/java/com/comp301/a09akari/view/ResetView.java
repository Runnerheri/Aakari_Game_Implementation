...
public class ResetView {
    ...
    Parent render(){
        ...
        next.setOnAction((ActionEvent event) ->{
            ...
            controller.getModel().setActivePuzzleIndex(controller.getModel().getActivePuzzleIndex() +1);
        });
    ...
    random.setOnAction(
        ...
        reset_button.setOnAction((ActionEvent actionEvent) -> {
                controller.getModel().resetPuzzle();
            });

        submit_button.setOnAction((ActionEvent actionEvent) ->{
